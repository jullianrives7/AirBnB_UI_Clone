...
const Footer = () => {
  return (
    <div id="footer-module-container">
      <div id="footer-inner">
        <div id="footer-left">
          <span
            style={{
          ...
          >
            &copy; 2022 Airbnb, Inc. <BsDot /> <p id="hover-font">Terms</p>
            <BsDot /> <p id="hover-font">Sitemap</p> <BsDot />{" "}
            <p id="hover-font">Privacy</p> <BsDot />{" "}
            <p id="hover-font">Your Privacy Choices</p>
            <svg
              width="26"
              height="12"
              fill="none"
        ...
        <div id="footer-right">
          ...
          >
            ...
            <span id="hover-font">English (US)</span>
          </div>
          <div
            style={{
              width: "28px",
