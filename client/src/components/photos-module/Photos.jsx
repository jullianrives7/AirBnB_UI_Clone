...
const Photos = () => {
  const { setShowPhotoModal, ApiUrl, setRentalData, rentalData } =
    ...
    <div id="photos-wrapper">
      ...
      <div id="photo-column">
        <Image
          ...
          // src="https://a0.muscache.com/im/pictures/4316b6ec-2afd-4d03-bc3e-8b2887304fc3.jpg?im_w=1200"
          onClick={() => setShowPhotoModal(true)}
        />
        <Image
          id="small-photo-2"
          ...
          // style={{ width: "270px", height: "270px" }}
          // src="https://a0.muscache.com/im/pictures/e690cc94-d29f-4dc7-9c8f-6ee7e9c26fe9.jpg?im_w=1200"
          onClick={() => setShowPhotoModal(true)}
        />
      </div>
      <div id="photo-column">
        <Image
          ...
          // style={{ width: "270px", height: "270px" }}
          // src="https://a0.muscache.com/im/pictures/11bf0999-efa2-4657-ba09-72e94441d539.jpg?im_w=1200"
          onClick={() => setShowPhotoModal(true)}
        />
        <Image
          id="small-photo-4"
          ...
          // style={{ width: "270px", height: "270px" }}
          // src="https://a0.muscache.com/im/pictures/be0e95ec-ad5b-4753-9877-7d29855c6beb.jpg?im_w=1200"
          onClick={() => setShowPhotoModal(true)}
        />
        <Button
