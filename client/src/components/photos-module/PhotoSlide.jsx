...
function PhotoSlide() {
  ...
  return (
    ...
    >
      ...
      <Carousel.Item>
        <img style={{height:'1000px',width:'1600px',marginLeft:'400px'}}
          className="d-block"
      ...
      <Carousel.Item>
        <img style={{height:'1000px',width:'700px',marginLeft:'800px'}}
          className="d-block"
      ...
      <Carousel.Item>
        <img style={{height:'auto',width:'auto',marginLeft:'400px',marginTop:'300px'}}
          className="d-block"
