...
const InformationAirCover = () => {
    const { setShowAirCoverModal, ApiUrl,setRentalData,rentalData } = useContext(appContext);
    const handleClick = () => {
  ...
  return (
    <div>
          <div> <img className="airCoverImg" src="https://a0.muscache.com/im/pictures/54e427bb-9cb7-4a81-94cf-78f19156faad.jpg"></img>
            ...
            <div className="airCoverButton" onClick={handleClick}><b><u>Learn more</u></b></div>
          </div>
    </div>
  );
};
